...
:: Get FULL python path - avoids VS Code or other program associations
for /f "usebackq tokens=*" %%p in (`python -c "import sys; print(sys.executable)"`) do set "PYTHON_EXE=%%p"
echo [OK] Python: !PYTHON_EXE!

:: Use pythonw.exe if available (no black console window shown to user)
...
:: LAUNCH - using full python path so Windows opens Python not VS Code
echo =====================================================
